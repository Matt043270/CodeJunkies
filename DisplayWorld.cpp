...
bool DisplayWorld::RenderWorld(bool lightsOn)
{
...
void DisplayWorld::deleteImageFromMemory()
{
	...
	deleteTempImageFromMemory(image);
}
//--------------------------------------------------------------------------------------
//  Delete raw image and clear memory
//--------------------------------------------------------------------------------------
void DisplayWorld::deleteTempImageFromMemory(unsigned char* tempImage)
{
	tempImage = NULL;
	if (tempImage == NULL)
	{
...
GLuint DisplayWorld::getWelcomeTex()
{
	return tp.GetTexture(WELCOME);
}

GLuint DisplayWorld::getExitTex()
{
	return tp.GetTexture(EXIT);
}

GLuint DisplayWorld::getNoExitTex()
{
	return tp.GetTexture(NO_EXIT);
}
...
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayChancPosts()
{
	int i;
...
void DisplayWorld::DrawChancPosts()
{
...
void DisplayWorld::DisplayDoorPosts()
{
	// Door Posts Chanc
...
void DisplayWorld::DrawDoorPosts()
{
	// DOORPOSTS_CHANC
...
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayAboveWindowBlock()
{
	int i;
...
void DisplayWorld::DrawAboveWindowBlock()
{
...
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayPurplePosts()
{
	int i;
...
void DisplayWorld::DrawPurplePosts()
{
...
void DisplayWorld::DisplayRedPosts()
{
...
void DisplayWorld::DrawRedPosts()
{
...
// Display Main Posts
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayMainPosts()
{
	int i, j;
	step = 0.0;
	stepLength = 0.0;
...
void DisplayWorld::DrawMainPosts()
{
...
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayPhysSciPosts()
{
...
void DisplayWorld::DrawPhysSciPosts()
{
	// WINDOWPOST_PS
...
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayDoorPaving()
{
...
void DisplayWorld::DrawDoorPaving()
{
...
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayLibraryPosts()
{
	int i, j;
	stepLength = 0.0;
	for (j = 0; j < 2; j++)
...
void DisplayWorld::DrawLibraryPosts()
{
...
//  Display Pavement
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayPavement()
{
	int i;
...
void DisplayWorld::DrawPavement()
{
	// PAVEMENT
...
void DisplayWorld::DisplayBricks()
{
	int i;
	// WALL_BRICK_YZ
...
// --------------------------------------------------------------------------------------
void DisplayWorld::DrawAngledRoofBeam(int listNo, GLdouble x, GLdouble y, GLdouble z, GLdouble beamSize)
{
...
void DisplayWorld::DrawAngledRoofBeam2(int listNo, GLdouble x, GLdouble y, GLdouble z, GLdouble beamSize)
{
	glNewList(listNo, GL_COMPILE);
	glBegin(GL_QUADS);
	glTexCoord2f(0.0, 0.0);
...
// Display Steps
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayEntranceSteps()
{
	int i;
...
// Display Bench
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayBench()
{
	int i, j;
	step2 = 3860.0;
	for (j = 0; j < 11; j++)
...
//--------------------------------------------------------------------------------------
void DisplayWorld::DisplayExtras()
{
	int i, j;
...
void DisplayWorld::DisplayLargerTextures()
{
	int i;
...
void DisplayWorld::DrawLargerTextures()
{
	// CHANC
...
void DisplayWorld::DisplayGrass()
{
...
// --------------------------------------------------------------------------------------
void DisplayWorld::DisplayLights()
{
	int i, j, k;
	// Light Fitting
...
void DisplayWorld::DisplayCylinders()
{
	// drainpipe
...
void DisplayWorld::DrawCylinders()
{
	// Drainpipe
...
// --------------------------------------------------------------------------------------
void DisplayWorld::DisplayStepBricks()
{
	int i, j;
	step = 0.0;
...
void DisplayWorld::DrawStepBricks()
{
...
//--------------------------------------------------------------------------------------
void DisplayWorld::CreateTextures()
{
